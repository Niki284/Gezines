...
<div class="creare  max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <form action="<?php echo e(route('people.store', ['parent_id' =>  $parent_id])); ?>" method="POST">
        ...
        <input type="hidden" name="beheerder_id" value="<?php echo e(Auth::id()); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\nikit\OneDrive\Bureaublad\TesteGezene\stamboom\resources\views/people/create.blade.php ENDPATH**/ ?>