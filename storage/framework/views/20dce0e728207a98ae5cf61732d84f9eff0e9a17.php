...
<body class="antialiased">
    ...
    <button type="submit">Искать</button>
            ...
            <ul>
                ...
                <li>
                    <a href="<?php echo e(route('people.show', $user->id)); ?>">
                    <div class="max-w-sm rounded overflow-hidden shadow-lg">
                        <img class="w-full" src="<?php echo e($user->img); ?>" alt="Sunset in the mountains">
                        <div class="px-6 py-4">
                            <div class="font-bold text-xl mb-2">The Coldest Sunset</div>
                            <p class="text-gray-700 text-base">
                            <?php echo e($user->name); ?> <?php echo e($user->last_name); ?>

                            is <?php echo e($user->age); ?> years old. 
                            </p>
                        </div>
...
</html><?php /**PATH C:\Users\nikit\OneDrive\Bureaublad\TesteGezene\stamboom\resources\views/welcome.blade.php ENDPATH**/ ?>